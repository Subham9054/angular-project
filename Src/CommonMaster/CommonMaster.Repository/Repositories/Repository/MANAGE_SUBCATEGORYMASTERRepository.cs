...
namespace CommonMaster.Repository.Repositories.Interfaces.MANAGE_SUBCATEGORYMASTER
{
    public class MANAGE_SUBCATEGORYMASTERRepository : db_PHED_CGRCRepositoryBase, IMANAGE_SUBCATEGORYMASTERRepository
    {
        ...
        public async Task<bool> InsertComplaintSubCategory(ComplaintSubCategoryModel complaintSub)
        {
            try
            {
                ...
                var result = await Connection.QueryAsync<int>("USP_InsertComplaintSubCategory", parameters, commandType: CommandType.StoredProcedure);
